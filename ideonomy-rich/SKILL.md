...
- Preserve the user's goal, constraints, requested methods, counts, axes, and output limits. On follow-ups, develop the existing organon and retain candidate IDs.
